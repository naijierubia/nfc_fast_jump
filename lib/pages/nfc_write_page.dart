    ...
    return Scaffold(
      ...
      body: GestureDetector(
        onHorizontalDragEnd: (details) {
          if (_musicLinks.isNotEmpty && !_isWriting) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ElevatedButton(
                            onPressed: (_currentIndex > 0 && !_isWriting)
                                ? _previousLink
                                : null,
                            child: const Text('上一个'),
                          ),
                          ElevatedButton(
                            onPressed: _isWriting ? null : _writeCurrentLink,
                            child: Text(_isWriting ? '写入中...' : '开始录入'),
                          ),
                          ElevatedButton(
                            onPressed:
